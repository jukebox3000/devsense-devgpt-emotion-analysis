...
//#region node_modules/.nitro/vite/services/ssr/assets/server-BRAljjW5.js
var server_BRAljjW5_exports = /* @__PURE__ */ __exportAll$1({
	a: () => __exportAll,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CRtYztL7.mjs");
...
var manifest = { "a15dbfb3c2bd69dfb87d0fc3b9afc9f03987c63ee02bfbf7eddbe186c17ea438": {
	...
	importer: () => import("./kpi-server-8Ni_sGGG.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-drLD2uJb.mjs").then((n) => n.t),
...
//#endregion
export { server_BRAljjW5_exports as a, getServerFnById as i, __exportAll as n, createServerFn as r, TSS_SERVER_FUNCTION as t };
